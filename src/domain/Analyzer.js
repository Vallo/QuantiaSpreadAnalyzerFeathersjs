...
exports.GetSpread = Spread;

async function Spread(moneda) {
    let prices = [];
...
exports.GetSpreadString = async function (moneda) {
...
function getAllPrices(moneda) { //todo hacer que no le pida monedas a todos sino a quienes operan tal moneda
    return Promise.all([
